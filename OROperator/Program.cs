...
namespace OROperator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //kui sisestatud kasutajatunnus on "admin" ja sisestatud salasõna "admin1234", siis konsoolis kuvatakse "Tere tulemast!";
            ...
            //"admin1" != "admin" || "admin123" != "admin1234" --> false || true --> true
